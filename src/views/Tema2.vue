...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-5
      ...
      .col-lg-7(data-aos="fade-left")
        AcordionA.mb-5(tipo="b" clase-tarjeta="tarjeta tarjeta--azul")
          ...
          .row(titulo="REST").align-items-center
            .col-md-2.col-6
              figure
                img(src='@/assets/curso/temas/tema2/3.svg', alt='Texto que describa la imagen')
            .col-md-10.mb-4.mb-md-0
              p Es el acrónimo de Transferencia de Estado de Representación. Es una interfaz que permite la conexión entre varios sistemas que utilizan el protocolo HTTP y determina cómo los usuarios visualizan la API. REST emplea los métodos de HTTP como GET, PUT, POST y DELETE para crear, modificar y borrar recursos de las bases de datos. (López & García, 2019)
          .row(titulo="API REST").align-items-center
            .col-md-2.col-6
              figure
                img(src='@/assets/curso/temas/tema2/4.svg', alt='Texto que describa la imagen')
            .col-md-10.mb-4.mb-md-0
              p Transfiere al usuario el estado de un recurso solicitado, lo que es de gran utilidad en la analítica de datos, porque permite solicitar a los modelos de #[em Machine learning], sus respectivas predicciones. Para esto, el servidor pasará las predicciones a un usuario, que puede ser una aplicación web, una APP móvil o cualquier plataforma que soporte HTTP.
                br
                br
                |Una API REST brinda las siguientes ventajas en el despliegue de una solución de #[em Machine learning]:
              ul.lista-ul
                li
    ...
    #t_2_1(data-aos='fade-right')
      h3.mb-4 Ejecución de la API localmente
    ...
    TabsB.color-acento-contenido.mb-5
      ...
      .py-4.py-md-5(titulo="Crear modelo" :icono="require('@/assets/curso/temas/tema2/8.svg')")
        .row
          .col-md-7.mb-4.mb-md-0
            p Una vez instaladas las herramientas, se inicia con la creación del modelo a desplegar. En este ejemplo, se trabajará con un <em>dataset</em> o conjunto de datos de Scikit-learn llamado Iris, que contiene información de una planta con tres clases de flores: <b>virginica, setosa y versicolor</b>. Cada clase tiene propiedades distintas que permiten clasificarla y predecir, a partir de estas variables, qué tipo de clase es.
      ...
      .py-4.py-md-5(titulo="Algoritmo de entrenamiento" :icono="require('@/assets/curso/temas/tema2/10.svg')")
        .row
          .col-md-7.mb-4.mb-md-0
            p Para realizar el entrenamiento, se utilizará el algoritmo de árboles de decisión. Luego de entrenado el modelo, se guardará su estado con la librería <b>Joblib</b> y, de este modo, en el proceso de despliegue, solo será necesario llamar al modelo, e ingresar los nuevos datos a predecir, sin necesidad de entrenar nuevamente. Se inicia con la creación de un archivo de nombre <b>modelo.py</b> que contiene el siguiente código: 
      ...
      .py-4.py-md-5(titulo="Lanzar modelo" :icono="require('@/assets/curso/temas/tema2/12.svg')")
        .row
          .col-md-7.mb-4.mb-md-0
            p Con el modelo entrenado y almacenado, se crea un nuevo archivo de nombre <b>app.py</b>, que tendrá las instrucciones necesarias para lanzar el modelo a producción:
    ...
    .row.justify-content-center.mb-5
      .col-lg-7(data-aos="fade-right")
        TabsA.color-acento-botones.tema2.mb-5
          ...
          .tarjeta.p-4(titulo="Escalabilidad" style="background-color: #dbeefe ")
            p Heroku permite aumentar y disminuir automáticamente la infraestructura contratada, lo que garantiza que las aplicaciones sigan funcionando, aún cuando la carga de usuarios concurrentes, es alta.
              br
              br
          ...
          .tarjeta.p-4(titulo="Despliegue" style="background-color: #dbeefe ")
            p Los despliegues que utilizan infraestructura como servicio (IAAS) requieren la creación de servidores virtuales y la instalación de sistemas operativos como Linux o Windows con sus versiones y actualizaciones. Por esta razón, los analistas de datos deben preocuparse porque sus modelos y aplicaciones usen requisitos compatibles con el servidor de despliegue, reduciendo los tiempos de entrega de la solución. 
              br
              br
              |Los #[b #[em dynos]] son contenedores aislados basados en sistemas operativos Linux, que sirven como componentes básicos para el despliegue de modelos y aplicaciones. Se pueden crear, de acuerdo con las necesidades del usuario, desde pequeños y económicos, los cuales ofrecen 1 procesador de CPU y 512 MB de capacidad de RAM, hasta contenedores más grande y costosos con procesadores de CPU ilimitados y hasta 32 GB de RAM.
    ...
    #t_2_3(data-aos='fade-right')
      h3.mb-4 Despliegue de la API con contenedores
    ...
    .row.justify-content-center.mb-5
      ...
      .bloque-derecha 
          .bloque-texto-g.color-primario.p-3.p-sm-4.p-md-5
            ...
            .bloque-texto-g__texto.p-4
              p.mb-0 Los contenedores se crearon, en un principio, para implementar juegos en línea, debido a que reducen la sobrecarga del sistema; tienen tiempos de implementación más rápidos y permiten a los equipos de desarrollo pensar menos en la implementación y más en el contenido en producción. Por lo tanto, los creadores de juegos como Riot Games de League of Legends los incorporan en sus proyectos.
      ...
      .col-xl-4.col-lg-4.col-md-9.col-11.mb-4.mb-xl-0
        .crd_hover_txt(data-aos="flip-left")
          ...
          .crd_hover_txt--body.w-100
            ...
            p.mb-0 Son la mejor opción para la virtualización. Estos virtualizan el sistema operativo, por lo general Linux, en lugar del #[em hardware], dejando que cada contenedor individual almacene el programa, sus bibliotecas y dependencias. Debido a que no siempre necesitan un sistema operativo huésped, como lo hacen las máquinas virtuales, los contenedores pueden hacer uso de las capacidades y recursos del sistema operativo #[em host], porque son pequeños, rápidos y portátiles. Entre los más usados están Docker y Kubernetes.
      .col-xl-4.col-lg-4.col-md-9.col-11.mb-4.mb-xl-0
        .crd_hover_txt(data-aos="flip-left")
          .crd_hover_txt--img
            figure
    ...
    .tarjeta.p-4.mb-5(style="background-color: #fffcf2 ")
      LineaTiempoC.color-acento-botones
        ...
        .row(titulo="Velocidad").px-5
          .col-md-6.mb-4.mb-md-0
              p Los contenedores Docker son livianos y rápidos, dado que se ejecutan en entornos separados del #[em kernel] del sistema operativo y, por lo tanto, hacen uso de pocos recursos. Así mismo, su creación y ejecución se puede realizar en pocos segundos en comparación con las máquinas virtuales que requieren más tiempo para iniciar el sistema operativo y cargar todos sus servicios y componentes.
          .col-md-6
            figure
